package com.vunhiem.lockscreenios.notification.adapter
...
class NotificationAdaper(var context:Context, var noti:ArrayList<Notification>,private val listener:ItemNotiListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
       return NotificationViewHolder(LayoutInflater.from(context).inflate(com.vunhiem.lockscreenios.R.layout.item_notifi,parent,false))
    }
